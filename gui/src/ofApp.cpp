...
void ofApp::draw(){
	...
	myText.drawString("How many...?", 30, 183); //"How many...?" category in menu
	ofSetColor(45, 163, 213); //Text colour for everything else
	myText.drawString("Money", 30, 235); //"Money" category in menu
	myText.drawString("Politics", 30, 290); //"Politics" category in menu
	myText.drawString("Paris", 30, 345); //"Paris" category in menu
	myText.drawString("Dreamworks", 30, 400); //"Dreamworks" category in menu
	myText.drawString("Uber", 30, 455); //"Uber" category in menu
	myText.drawString("Youtube", 30, 510); //"Youtube" category in menu
	myText.drawString("Animal", 30, 565); //"Animal" category in menu
	myText.drawString("Music", 30, 620); //"Music" category in menu
